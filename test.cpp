...
void opencv_test() {
    ...
    std::string pipeline = "v4l2src device=/dev/video60 ! video/x-raw, width=640, height=480, framerate=30/1 ! videoconvert ! rtspclientsink location=rtsp://localhost:8554/mystream";
